...
using SQLAlchemy, for the gbparser database. It is based on the mutalyzer db.
"""
...
class SessionFactory(sessionmaker):
    ...
    current settings.DATABASE_GB_URI.
    """
...
def create_engine():
    ...
    """
    if not settings.DATABASE_GB_URI:
    ...
    url = make_url(settings.DATABASE_GB_URI)
    options = {}
